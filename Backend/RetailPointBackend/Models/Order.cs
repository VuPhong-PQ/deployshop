...
namespace RetailPointBackend.Models
{
    public class Order
    {
        ...
        public string? Currency { get; set; } // USD, EUR cho ngoại tệ (banktransfer)
        public string? SplitPaymentDetails { get; set; } // JSON: [{"method":"cash","methodName":"Tiền mặt","amount":30000},{"method":"card","methodName":"Thẻ ngân hàng","amount":70000}]
