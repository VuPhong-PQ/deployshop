...
namespace RetailPointBackend.Migrations
{
    ...
    [Migration("20251121034004_AddCurrencyToOrders")]
    partial class AddCurrencyToOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailPointBackend.Models.LoyaltyConfig", b =>
                {
                    b.Property<int>("LoyaltyConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LoyaltyConfigId"));

                    b.Property<bool>("AllowPointRedemption")
                        .HasColumnType("bit");

                    b.Property<bool>("BirthdayBonusEnabled")
                        .HasColumnType("bit");

                    b.Property<decimal>("BirthdayMultiplier")
                        .HasPrecision(3, 2)
                        .HasColumnType("decimal(3,2)");
                    ...
                    b.Property<decimal>("HappyHourMultiplier")
                        .HasPrecision(3, 2)
                        .HasColumnType("decimal(3,2)");
                    ...
                    b.Property<decimal>("MinOrderAmountForPoints")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("WeekendBonusEnabled")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HappyHourEndTime = new TimeSpan(0, 19, 0, 0, 0),
                            HappyHourMultiplier = 2.0m,
                            HappyHourStartTime = new TimeSpan(0, 17, 0, 0, 0),
                            IsEnabled = true,
                            MaxRedemptionPercentage = 50.0m,
                            MinOrderAmountForPoints = 50000m,
                            PointExpiryDays = 365,
                            PointValue = 1000.0m,
            ...
            modelBuilder.Entity("RetailPointBackend.Models.LoyaltyPromotion", b =>
                {
                    ...
                    b.Property<int?>("TargetCustomerTier")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RetailPointBackend.Models.LoyaltySettings", b =>
                {
                    ...
                    b.Property<bool>("IsPointsEnabled")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PointsRate = 1000m,
                            RedemptionRate = 1000m,
                            UpdatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("RetailPointBackend.Models.LoyaltyTransaction", b =>
                {
                    b.Property<int>("TransactionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RetailPointBackend.Models.StaffStore", b =>
                {
                    b.Property<int>("StaffStoreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StaffStoreId"));
            ...
            modelBuilder.Entity("RetailPointBackend.Models.Customer", b =>
                {
                    ...
                    b.HasOne("RetailPointBackend.Models.CustomerTier", "CustomerTier")
                        .WithMany()
            ...
            modelBuilder.Entity("RetailPointBackend.Models.LoyaltyPromotion", b =>
                {
                    ...
                    b.HasOne("RetailPointBackend.Models.CustomerTier", "CustomerTier")
                        .WithMany()
                        .HasForeignKey("TargetCustomerTier");
            ...
            modelBuilder.Entity("RetailPointBackend.Models.LoyaltyTransaction", b =>
                {
                    ...
                    b.HasOne("RetailPointBackend.Models.Staff", "ProcessedByStaff")
                        .WithMany()
